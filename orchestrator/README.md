...
This module implements the **Dual-Phase One-Inference** architecture, which ensures that EVA perceives and feels her environment before generating a rationalized response.
...
- **Response Dispatch**: Finalizing and outputting EVA's response.
...
The **Identity & Behavioral Subsystem**. It ensures EVA follows her core principles (`persona.yaml` and `soul.md`) and respects behavioral constraints.
